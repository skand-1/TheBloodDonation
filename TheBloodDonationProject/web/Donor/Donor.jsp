...
//String path = request.getRealPath("/Login.html");
                ...
                <div class="col m10 offset-m1">
                    <div class="card updateinfo-card">
                            ...
                            <div class="form">
                                <form action="updateinfo" method="post">
                                    <div class="row">
                                        <div class="col s12 m6">
                                            <div class="input-field col s12">
                                                <input type="text" name="ufname" value="" required>
                                                <label for="ufname">First Name</label>
                                            </div>
                                        </div>
                                        <div class="col s12 m6">
                                            <div class="input-field col s12">
                                                <input type="text" name="ulname" value="" required>
                                    ...
                                    <div class="row">
                                        <div class="col s12 m6">
                                            <div class="input-field col s12">
                                                <input type="tel" name="uphno" maxlength="10" value="" required>
                                                <label for="uphno">Phone no</label>
                                            </div>
                                        </div>
                                        <div class="col s12 m6">
                                            <div class="input-field col s12">
                                                <input type="tel" name="sphno" minlength="10" maxlength="10" value="">
                                    ...
                                    <div class="row">
                                        <div class="col s12 m6">
                                            ...
                                            <div class="input-field col s12">
                                                <input type="email" name="uemail" class="validate" value="" required>
                                                <label for="uemail">E mail</label>
                                            </div>
                                        </div>
                                        <div class="col s12 m6">
                                            <div class="input-field col s12">
                                                <input type="password" name="upwd" value="" required>
                                    ...
                                    <div class="row">
                                        <div class="col s12 m6">
                                            <div class="input-field col s12">
                                                <input type="text" class="datepicker" id="ubdate" value="" required>
                                        ...
                                        <div class="col s12 m6">
                                            <div class="input-field col s12">
                                                <input type="number" name="uage" value="" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12 m6">
                                            <div class="input-field col s12">
                                                <input type="number" name="uweight" value="" required>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12 ">
                                            <textarea name="uaddress" id="textarea1" class="materialize-textarea"
                                                value="" required></textarea></textarea>
                        ...
                        <div class="card-action center">
                            <button class="btn waves-effect red">Save Changes</button>
                        </div>
                    </div>
                </div>
    </section>
